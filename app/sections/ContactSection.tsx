              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-muted hover:bg-neon/10 hover:text-neon border border-transparent hover:border-neon/30 transition-all"
                  >
